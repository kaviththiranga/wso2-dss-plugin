...
import com.codenvy.ide.jseditor.client.texteditor.EmbeddedTextEditor;
 ...
 */
public class DBSMultiPageEditorViewImpl extends Composite implements DBSMultiPageEditorView {

    interface DBSMultiPageEditorViewImplUiBinder
            extends UiBinder<Widget, DBSMultiPageEditorViewImpl> {
    }
    ...
    @Inject
    public DBSMultiPageEditorViewImpl() {
