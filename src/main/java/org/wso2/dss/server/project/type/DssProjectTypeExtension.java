 ...
 */
@Singleton
public class DssProjectTypeExtension implements ProjectTypeExtension {

    private final ProjectType projectType;

    @Inject
    public DssProjectTypeExtension(ProjectTypeDescriptionRegistry registry) {
        projectType = new ProjectType(ProjectConstants.PROJECT_ID, ProjectConstants.PROJECT_NAME, ProjectConstants.CATEGORY);
